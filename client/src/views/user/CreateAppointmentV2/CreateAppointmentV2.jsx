...
import CreateAppointmentV2 from '../../../components/user/scheduling/CreateApptV2/CreateApptV2';
import ConfirmAppt from '../../../components/user/scheduling/ConfirmAppt/ConfirmAppt';

export default class CreateAppointmentViewV2 extends React.Component{
    state = {
        btnDisabled:true,
        serverErrorMsg:null,
        redirect:null,
    ...
    toggleBack = () =>{
        let newState = this.state;
        let i = this.state.indexSelected;
        newState.dateSelectedIndex = null;
                    ...
                    <BoxContainer serverErrorMsg={this.state.serverErrorMsg}>
                        <div className='row'>
                            ...
                            {this.state.data.length>0?
                                ...
                                <CreateAppointmentV2 currentServiceType={this.state.data[this.state.indexSelected].plan.description}
                                    ...
                                    timeFrames={this.state.timeFrames} dates={this.state.dates} togglePeriodOfDay={this.togglePeriodOfDay} dateSelectedIndex={this.state.dateSelectedIndex}/>
                        ...
                        <div className='row'>
                            ...
                            <div className={"col-lg-4 col-md-12 "+(this.state.data.length>0 && !this.state.data[this.state.indexSelected].isBack?"offset-lg-8":"offset-lg-4")}>
                                {this.state.data.length>0 && !this.state.data[this.state.indexSelected].spot && !this.state.isContinue?
